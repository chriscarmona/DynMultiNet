...
sample_mu_t_DynMultiNet_bin_cpp <- function(mu_t, mu_t_cov_prior_inv, y_ijt, w_ijt, s_ijt, directed = FALSE) {
    .Call(`_DynMultiNet_sample_mu_t_DynMultiNet_bin_cpp`, mu_t, mu_t_cov_prior_inv, y_ijt, w_ijt, s_ijt, directed)
}

sample_mu_t_DynMultiNet_bin_v2_cpp <- function(mu_t, mu_t_cov_prior_inv, y_ijt, w_ijt, s_ijt, directed = FALSE) {
...
sample_x_ith_shared_DynMultiNet_bin_cpp <- function(x_ith_shared, x_t_sigma_prior_inv, tau_h, y_ijtk, w_ijtk, s_ijtk) {
    .Call(`_DynMultiNet_sample_x_ith_shared_DynMultiNet_bin_cpp`, x_ith_shared, x_t_sigma_prior_inv, tau_h, y_ijtk, w_ijtk, s_ijtk)
}
...
sample_x_ith_DynMultiNet_bin_dir_cpp <- function(x_ith_send, x_ith_receive, x_t_sigma_prior_inv, tau_h_send, tau_h_receive, y_ijt, w_ijt, s_ijt) {
    .Call(`_DynMultiNet_sample_x_ith_DynMultiNet_bin_dir_cpp`, x_ith_send, x_ith_receive, x_t_sigma_prior_inv, tau_h_send, tau_h_receive, y_ijt, w_ijt, s_ijt)
}
