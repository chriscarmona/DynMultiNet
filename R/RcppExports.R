...
sample_baseline_t_link_cpp <- function(mu_t, mu_t_cov_prior_inv, y_ijt, w_ijt, s_ijt, directed = FALSE) {
    .Call(`_DynMultiNet_sample_baseline_t_link_cpp`, mu_t, mu_t_cov_prior_inv, y_ijt, w_ijt, s_ijt, directed)
}
