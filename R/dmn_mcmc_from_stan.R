...
dmn_mcmc_from_stan <- function( stan_fit,
  ...
  if( !directed & !weighted ) {
    ...
    dmn_mcmc <- list( y_ijtk=NULL,
                      ...
                      x_ith_shared_mcmc = aperm(posterior[["x_t_hi_shared"]],c(4,5,3,1,2)),
                      x_ithk_mcmc = aperm(posterior[["x_t_hki"]],c(5,6,3,4,1,2)),
                      tau_h_shared_mcmc = aperm(posterior[["tau_h_shared"]],c(3,1,2) ),
                      tau_h_k_mcmc = aperm(posterior[["tau_hk"]],c(3,4,1,2)),
                      ...
                      u_ith_shared_mcmc = aperm(posterior[["u_t_hi_shared"]],c(4,5,3,1,2)),
                      u_ithk_mcmc = aperm(posterior[["u_t_hki"]],c(5,6,3,4,1,2)),
                      rho_h_shared_mcmc = aperm(posterior[["rho_h_shared"]],c(3,1,2) ),
                      rho_h_k_mcmc = aperm(posterior[["rho_hk"]],c(3,4,1,2)),
...
dmn_mcmc_from_stan_failed <- function( sample_file,
  ...
  if( directed & weighted ) {
    ...
    dmn_mcmc <- list( y_ijtk=NULL,
                      ...
                      mu_tk_mcmc = aperm(posterior[["mu_t_k"]],c(3,2,1)),
                      x_ith_shared_mcmc = aperm(posterior[["x_t_hi_shared"]],c(2,4,5,3,1)),
                      x_ithk_mcmc = aperm(posterior[["x_t_hki"]],c(2,5,6,3,4,1)),
                      tau_h_shared_mcmc = aperm(posterior[["tau_h_shared"]],c(2,3,1) ),
                      tau_h_k_mcmc = aperm(posterior[["tau_hk"]],c(2,3,4,1)),
                      ...
                      lambda_tk_mcmc = aperm(posterior[["lambda_t_k"]],c(3,2,1)),
                      u_ith_shared_mcmc = aperm(posterior[["u_t_hi_shared"]],c(2,4,5,3,1)),
                      u_ithk_mcmc = aperm(posterior[["u_t_hki"]],c(2,5,6,3,4,1)),
                      rho_h_shared_mcmc = aperm(posterior[["rho_h_shared"]],c(2,3,1) ),
                      rho_h_k_mcmc = aperm(posterior[["rho_hk"]],c(2,3,4,1)),
