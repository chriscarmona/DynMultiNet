...
namespace DynMultiNet {
    ...
    inline Rcpp::List sample_baseline_t_link_GP_cpp(arma::colvec eta_t, const arma::cube y_ijt, const arma::cube w_ijt, arma::cube gamma_ijt, const arma::mat eta_t_cov_prior_inv, const bool lat_mean, double eta_t_bar, const double sigma_eta_bar, const bool directed = false) {
        typedef SEXP(*Ptr_sample_baseline_t_link_GP_cpp)(SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP);
        static Ptr_sample_baseline_t_link_GP_cpp p_sample_baseline_t_link_GP_cpp = NULL;
        if (p_sample_baseline_t_link_GP_cpp == NULL) {
            validateSignature("Rcpp::List(*sample_baseline_t_link_GP_cpp)(arma::colvec,const arma::cube,const arma::cube,arma::cube,const arma::mat,const bool,double,const double,const bool)");
        ...
        RObject rcpp_result_gen;
        {
            ...
            rcpp_result_gen = p_sample_baseline_t_link_GP_cpp(Shield<SEXP>(Rcpp::wrap(eta_t)), Shield<SEXP>(Rcpp::wrap(y_ijt)), Shield<SEXP>(Rcpp::wrap(w_ijt)), Shield<SEXP>(Rcpp::wrap(gamma_ijt)), Shield<SEXP>(Rcpp::wrap(eta_t_cov_prior_inv)), Shield<SEXP>(Rcpp::wrap(lat_mean)), Shield<SEXP>(Rcpp::wrap(eta_t_bar)), Shield<SEXP>(Rcpp::wrap(sigma_eta_bar)), Shield<SEXP>(Rcpp::wrap(directed)));
        }
    ...
    inline Rcpp::List sample_add_eff_it_shared_link_cpp(arma::colvec sp_it, const arma::field<arma::cube> y_ijtk, arma::field<arma::cube> w_ijtk, arma::field<arma::cube> gamma_ijtk, const arma::mat sp_t_cov_prior_inv, const bool lat_mean, arma::colvec sp_it_bar, const double sigma_sp_bar, const bool directed = false) {
        typedef SEXP(*Ptr_sample_add_eff_it_shared_link_cpp)(SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP);
        ...
        if (p_sample_add_eff_it_shared_link_cpp == NULL) {
            validateSignature("Rcpp::List(*sample_add_eff_it_shared_link_cpp)(arma::colvec,const arma::field<arma::cube>,arma::field<arma::cube>,arma::field<arma::cube>,const arma::mat,const bool,arma::colvec,const double,const bool)");
        ...
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_sample_add_eff_it_shared_link_cpp(Shield<SEXP>(Rcpp::wrap(sp_it)), Shield<SEXP>(Rcpp::wrap(y_ijtk)), Shield<SEXP>(Rcpp::wrap(w_ijtk)), Shield<SEXP>(Rcpp::wrap(gamma_ijtk)), Shield<SEXP>(Rcpp::wrap(sp_t_cov_prior_inv)), Shield<SEXP>(Rcpp::wrap(lat_mean)), Shield<SEXP>(Rcpp::wrap(sp_it_bar)), Shield<SEXP>(Rcpp::wrap(sigma_sp_bar)), Shield<SEXP>(Rcpp::wrap(directed)));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (Rcpp::internal::isLongjumpSentinel(rcpp_result_gen))
